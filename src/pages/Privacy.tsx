    ...
    <div className="min-h-screen pt-16 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-gray-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-4">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-4">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-4">Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-4">Your Rights</h2>
