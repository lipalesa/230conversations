        ...
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:space-x-6 mb-8 space-y-3 md:space-y-0">
            <div className="flex items-center text-gray-700">
              <Calendar size={20} className="mr-2 text-[#a57614]" />
              <span className="font-medium">{formatDate(event.date)}</span>
            </div>
            {event.location && (
              <div className="flex items-center text-gray-700">
                <MapPin size={20} className="mr-2 text-[#a57614]" />
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Interested in Attending?</h3>
            <p className="text-gray-700 mb-6">
              We'd love to see you there! Connect with us to get more details and register for this event.
            </p>
            <Link
              to="/connect"
              className="inline-block bg-[#a57614] text-white px-8 py-3 rounded-md hover:bg-[#8c6310] transition-colors font-semibold"
            >
              Get Connected
            </Link>
          </div>
